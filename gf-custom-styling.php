...
function load_gravity_forms_css()
{
    ...
    wp_enqueue_script('script-autosize', plugin_dir_url(__FILE__) . '/js/autosize.js', array( 'jquery' ));
    wp_enqueue_script('script-custom', plugin_dir_url(__FILE__) . '/js/main.js', array( 'jquery' ));
}
